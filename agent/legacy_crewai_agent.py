"""Legacy CrewAI prototype for Moroccan real-estate analysis.

This module orchestrates search and website-scraping tools. The structured
dataset collectors live separately in the ``scraping`` package.
"""
